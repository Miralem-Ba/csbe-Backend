...
- [Sicherheit](#sicherheit)
  - [Authentifizierung und Autorisierung](#Authentifizierung-und-Autorisierung)
    ...
    - [Code-Sicherheit](#Code-Sicherheit)
    - [Drittanbieter-Komponenten](#Drittanbieter-Komponenten)
    - [ Meine Empfehlungen für euch](#Meine-Empfehlungen-für-euch)
- [Authentifizierung](#authentifizierung)
  - [Meine Methoden](#Meine-Methoden)
  - [Zwei-Faktor-Authentifizierung](#Zwei-Faktor-Authentifizierung)
  - [Tokens und API-Zugriff](#Tokens-und-API-Zugriff)
  - [Meine Empfehlungen](#Meine-Empfehlungen)
- [Dateistruktur](#dateistruktur)
- [Tabellenstruktur](#tabellenstruktur)
  - [Tabelle: Produkt](#Tabelle-Produkt)
  - [Tabelle: Benutzer](#Tabelle-Benutzer)
  - [Tabelle: Kategorie](#Tabelle-Kategorie)
...
|             | - Fehlermeldung SQL kann ich nicht aufheben.                                        |             3.5h|
